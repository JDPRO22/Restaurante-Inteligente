...
const defaultAdminPassword = appConfig?.secrets?.adminPasswordDefault || '1234';
const defaultKitchenPassword = appConfig?.secrets?.kitchenPasswordDefault || 'cozinha';
...
<div class="footer">Relatório gerado automaticamente pelo sistema · Restaurante Deus é Fiel</div>
...
window.finalizarPedidoBalcao = async () => {
    ...
    document.getElementById('comanda-conteudo').innerHTML = `
        ...
        <hr class="com-divider">
        <div style="text-align:center;font-size:0.8rem;margin-top:6px;">✨ Deus é Fiel! ✨</div>
    `;
